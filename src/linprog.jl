...
"""
    linprog(c; x0, Aineq, blow, bupp, Aeq, beq, lvar, uvar, kwargs...)
...
"""
    linprog(c, A, b, Aeq, beq; x0, kwargs...)
...
"""
    linprog(c, A, b, lvar, uvar; x0, kwargs...)
...
"""
    linprog(c, A, b, Aeq, beq, lvar, uvar; x0, kwargs...)
...
"""
    linprog(c, Aineq, blow, bupp; x0, kwargs...)
