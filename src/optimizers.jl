...
HandleNonDoublePrecisionTrait(::Type{TrunkSolver}) = NoHandleNonDouble()
HandleNonDoublePrecisionTrait(::Type{LBFGSSolver}) = NoHandleNonDouble()
HandleNonDoublePrecisionTrait(::Type{TronSolver}) = NoHandleNonDouble()
HandleNonDoublePrecisionTrait(::Type{PercivalSolver}) = NoHandleNonDouble()
