...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/JuliaSmoothOptimizers/JSOSuite.jl
   ```
...
- After that runs, the [stable docs](https://JuliaSmoothOptimizers.github.io/JSOSuite.jl/stable) should be updated. Check them and look for the version number.
